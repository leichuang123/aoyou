...
import { newUserList, newUserListExport } from '../../server/api'
...
class newUser extends React.Component<RouteComponentProps & Props> {
  ...
  private async getList () {
    ...
    if (res.success === 'true') {
      if (!res.info.recordList) {
        res.info.recordList = res.info.retentionList // 服务器的原因
      }
      if (!res.info.recordList) {
        res.info.recordList = []
      }
